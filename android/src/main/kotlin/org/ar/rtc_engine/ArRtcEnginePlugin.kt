...
import org.ar.rtc.base.RtcEngineManager
import kotlin.reflect.full.declaredMemberFunctions
import kotlin.reflect.jvm.javaMethod

/** ARRtcEnginePlugin */
class ArRtcEnginePlugin : FlutterPlugin, MethodCallHandler, EventChannel.StreamHandler {
    ...
    private fun initPlugin(context: Context, binaryMessenger: BinaryMessenger, platformViewRegistry: PlatformViewRegistry) {
        ...
        methodChannel = MethodChannel(binaryMessenger, "ar_rtc_engine")

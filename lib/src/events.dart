...
typedef UserAccountCallback = void Function(String uid, String userAccount);
typedef UserInfoCallback = void Function(String uid, UserInfo userInfo);
typedef ClientRoleCallback = void Function(
    ClientRole oldRole, ClientRole newRole);
typedef UidWithElapsedCallback = void Function(String uid, int elapsed);
typedef UserOfflineCallback = void Function(String uid, UserOfflineReason reason);
...
typedef UidCallback = void Function(String uid);
...
typedef UidWithMutedCallback = void Function(String uid, bool muted);
typedef VideoSizeCallback = void Function(
    String uid, int width, int height, int rotation);
typedef RemoteVideoStateCallback = void Function(String uid,
...
typedef RemoteAudioStateCallback = void Function(String uid,
...
typedef FallbackWithUidCallback = void Function(
    String uid, bool isFallbackOrRecover);
...
typedef NetworkQualityWithUidCallback = void Function(
    String uid, NetworkQuality txQuality, NetworkQuality rxQuality);
...
typedef StreamInjectedStatusCallback = void Function(
    String url, String uid, InjectStreamStatus status);
typedef StreamMessageCallback = void Function(
    String uid, int streamId, String data);
typedef StreamMessageErrorCallback = void Function(
    String uid, int streamId, ErrorCode error, int missed, int cached);
...
typedef TransportStatsCallback = void Function(
    String uid, int delay, int lost, int rxKBitRate);
typedef UidWithEnabledCallback = void Function(String uid, bool enabled);
typedef EnabledCallback = void Function(bool enabled);
typedef AudioQualityCallback = void Function(
    String uid, int quality, int delay, int lost);
typedef MetadataCallback = void Function(
    String buffer, String uid, int timeStampMs);
...
class RtcEngineEventHandler {
  ...
  /// - [String]: `uid`: ID of the remote user sending the stream.
  /// - [bool] `isFallbackOrRecover`: Whether the published stream fell back to audio-only or switched back to the video:
  /// -- `true`: The published stream fell back to audio-only due to poor network conditions.
  /// -- `false`: The published stream switched back to the video after the network conditions improved.

...
public class ArRtcMediaPlayerPlugin: NSObject, FlutterPlugin, FlutterStreamHandler {
    private final weak var rtcEnginePlugin: SwiftArRtcEnginePlugin?
    private var methodChannel: FlutterMethodChannel?
    private var eventChannel: FlutterEventChannel?
    private var eventSink: FlutterEventSink? = nil
    private lazy var manager: RtcMediaPlayerManager = {
        return RtcMediaPlayerManager() { [weak self] methodName, data in
    ...
    public func initPlugin(_ registrar: FlutterPluginRegistrar) {
        methodChannel = FlutterMethodChannel(name: "ar_rtc_media_player", binaryMessenger: registrar.messenger())
        eventChannel = FlutterEventChannel(name: "ar_rtc_media_player/events", binaryMessenger: registrar.messenger())
